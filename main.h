...
#define CONTROLS_LAUNCH SDLK_SPACE
#define CONTROLS_PAUSE SDLK_p
#define MOUSE_CONTROLS_LAUNCH SDL_BUTTON_LEFT
...
#define INITIAL_PADDLE_HEIGHT 4
...
#define INITIAL_BALL_ANGLE (M_PI / 4.0f)
